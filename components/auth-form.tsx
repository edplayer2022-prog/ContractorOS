...
export function AuthForm({ mode, action }: { mode: "login" | "signup" | "forgot"; action: (state: AuthState, data: FormData) => Promise<AuthState> }) {
